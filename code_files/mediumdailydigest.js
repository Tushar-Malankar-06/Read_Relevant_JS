...
const PROMPT_PATH = path.join(__dirname, '../prompts/mediumdailydigest_prompt.txt');
...
async function processFiles() {
  ...
  const files = fs.readdirSync(RAW_XML_DIR).filter(f => f.startsWith('medium_') && f.endsWith('.xml'));
